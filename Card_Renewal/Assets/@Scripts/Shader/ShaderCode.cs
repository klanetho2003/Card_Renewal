...
public class ShaderCode : MonoBehaviour
{
    ...
    Image image;
    Material m;
    UI_GameScene_CardBase<CardBase> visual;
    ...
    void Start()
    {
        ...
        image.material = m;
        visual = GetComponentInParent<UI_GameScene_CardBase<CardBase>>();
    ...
    void Update()
    {
        ...
        m.SetVector("_Rotation", new Vector2(Extension.Remap(xAngle,-20,20,-.5f,.5f), Extension.Remap(yAngle, -20, 20, -.5f, .5f)));
